...
installments with a 5% interest rate per month. How much do you need to pay each month?
...
So we have to pay around $32,525 per month.
Beware ! The interest rate must be expressed in months in this case. If you have
a 5% interest per year, you need to divise this by 12 to have the interest per
month :
...
So we have to pay around $17,764 per month. Of course, this amount is smaller as
the montly interest rate is lower...
